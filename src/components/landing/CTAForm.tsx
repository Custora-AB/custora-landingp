              ...
              <div className="bg-card rounded-2xl p-6 lg:p-8 shadow-xl">
                {isSubmitted ? <div className="text-center py-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="email" name="email" type="email" value={formData.email} onChange={handleChange} placeholder="you@company.com" required className="bg-background border-border" />
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="company" className="text-foreground">Company name</Label>
                      <Input id="company" name="company" value={formData.company} onChange={handleChange} placeholder="Your company" required className="bg-background border-border" />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea id="message" name="message" value={formData.message} onChange={handleChange} placeholder="Number of entities, current challenges, etc." rows={3} className="bg-background border-border resize-none" />
                    </div>
