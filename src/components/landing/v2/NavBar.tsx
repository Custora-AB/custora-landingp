    ...
    >
      <nav className="mx-auto flex h-24 max-w-[1600px] items-center justify-between px-6 sm:px-10 lg:px-14">
        ...
        <a
          ...
          className="rounded-full border border-black bg-white px-6 py-3 text-sm font-medium text-black shadow-[0_4px_20px_rgba(5,28,44,0.10)] transition-shadow hover:shadow-[0_6px_24px_rgba(5,28,44,0.16)] sm:text-base"
        >
          Log In
        </a>
      </nav>
